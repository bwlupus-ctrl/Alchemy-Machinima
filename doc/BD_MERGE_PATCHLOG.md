...
| G5.1 decoded-texture RAM pool | Stage 1 spike **landed**; Stage 2 **core landed** (pool + LRU + auto-size + fetch integration; user ruling 2026-07-10: build ahead of full spike data — report #1 evidence sufficient). Stage 2b open: tiered residency, per-discard entries, non-texture assets, dedicated worker pool | G5.0 ✓ |
