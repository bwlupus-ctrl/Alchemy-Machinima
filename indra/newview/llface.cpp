...
bool LLFace::canRenderAsMask()
{
    ...
    // One policy owns routing for legacy and PBR. PBR is handled by its own
    // pool/pass selection below LLVOVolume, while this helper applies the same
    // resolved decision to legacy auto-mask routing.
    const LLPipeline::AlphaPolicy alpha_policy =
        LLPipeline::resolveAlphaPolicy(this);
