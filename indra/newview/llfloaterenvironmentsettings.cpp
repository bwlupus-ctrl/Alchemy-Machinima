 ...
 * I:\black-dragon\indra\newview\llfloaterenvironmentsettings.cpp, NiranV Dean).
 * Adaptations vs donor: gDragonLibrary -> gBDMergeEnvLibrary.
 *
...
{
    //BD
    gBDMergeEnvLibrary.onSelectPreset(mWaterPresetCombo, mLiveWater);
...
{
    //BD
    gBDMergeEnvLibrary.onSelectPreset(mSkyPresetCombo, mLiveSky);
...
{
    //BD
    gBDMergeEnvLibrary.onSelectPreset(mDayCyclePresetCombo, mLiveDay);
...
{
    gBDMergeEnvLibrary.loadPresetsFromDir(mWaterPresetCombo, "water");
    gBDMergeEnvLibrary.addInventoryPresets(mWaterPresetCombo, mLiveWater);
}

void LLFloaterEnvironmentSettings::populateSkyPresetsList()
{
    gBDMergeEnvLibrary.loadPresetsFromDir(mSkyPresetCombo, "skies");
    gBDMergeEnvLibrary.addInventoryPresets(mSkyPresetCombo, mLiveSky);
}

void LLFloaterEnvironmentSettings::populateDayCyclePresetsList()
{
    gBDMergeEnvLibrary.loadPresetsFromDir(mDayCyclePresetCombo, "days");
    gBDMergeEnvLibrary.addInventoryPresets(mDayCyclePresetCombo, mLiveDay);
}
