...
// [BDMerge C6] Separate resizable/movable snapshot preview floater. This is
// LL's stock LLFloaterBigPreview (removed upstream in 44c6630838 "#5419
// remove old unused floater"), resurrected verbatim and rewired to the
// snapshot floater the way Black Dragon uses it. donor: Black Dragon
// (NiranV Dean) fab3226ac5/f0db8914d0/d6c8a45325/4d0faf18c4. The draw()
// early-return below replaces BD's hide/show dance from d6c8a45325 with
// Alchemy's own LLFloaterSnapshot::draw() self-exclusion pattern.
...
void LLFloaterBigPreview::draw()
{
    ...
    // [BDMerge C6] don't render this floater into snapshots taken with
    // "show UI" (same self-exclusion pattern as LLFloaterSnapshot::draw();
    // replaces BD's hide/restore in rawSnapshot, donor d6c8a45325)
