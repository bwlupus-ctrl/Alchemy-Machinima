...
void default_lighting()
{
    ...
    {
        // This forward path has no emissive GBuffer.  Add the same linear
        // Actor FX lift used by deferred/PBR after scene lighting, then return
        // to the legacy shader's sRGB soft-clip domain.
