...
// [BDMerge A5.4-3] Per-pixel motion blur composite. Donor: Black Dragon
// motionBlurF.glsl. 32-tap triangle-weighted gather centered on the pixel,
// along the velocity buffer's NDC motion vector (camera + rigid + rigged +
// classic-avatar motion since Phase 1b). Early-out under half a pixel of
// motion; blur length capped by motion_blur_strength (pixels).
