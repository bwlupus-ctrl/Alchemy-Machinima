/**
 * Shared Actor FX synthetic PBR glow vertex shader.
 *
 * Zero-authored-glow PBR VBOs do not carry TYPE_EMISSIVE.  Keeping this
 * colour-stream program separate from sharedActorFxPbrGlowV preserves the
 * native vertex-glow scale where it exists without making synthetic looks
 * depend on an attribute their source geometry cannot provide.
 */
