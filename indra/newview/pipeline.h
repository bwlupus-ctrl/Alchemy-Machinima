...
public:
    ...
    // Resolve Graduated ND + Polarizer settings and set their packed uniforms on
    // the color-correct shader (the filters are applied inside colorCorrectF).
    void setOnLensFilterUniforms(LLGLSLShader* shader, LLRenderTarget* src);
